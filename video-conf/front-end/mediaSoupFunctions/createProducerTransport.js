...
const createProducerTransport = (socket,device)=>new Promise(async(resolve, reject)=>{
    ...
    const producerTransport = device.createSendTransport(producerTransportParams) // 7.1 Create sendTransport with params
    // console.log(producerTransport)
    // 7.2 Listen for connect
